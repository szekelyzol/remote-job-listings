...
I've *curated* the list on `2026-07-12`. This means I checked whether:
...
| **Website** | **Notes** |
|---|---|
| [Himalayas.app](https://himalayas.app/jobs) | Mostly US-based remote only. |
| [We Work Remotely](https://weworkremotely.com/remote-jobs/search) | Well maintained and has LinkedIn integration. |
| [PostHog's Cool tech jobs](https://posthog.com/cool-tech-jobs) | Hand-picked by the PostHog team. It's cool, but not always up-to-date as old postings are not removed. ⚠️|
| [Cord](https://cord.co/jobs) | Mostly UK-only, with a weird chat feature, but has nice filters.  |
| [Remote Rocketship](https://www.remoterocketship.com) | You have to log in to apply via the platform, but it is a good reference for companies with new postings. |
| [Indeed](https://www.indeed.com/) | Updated frequently. Can filter for 'date posted', but the exact dates are not shown. |
...
| [Working Nomads](https://www.workingnomads.com/jobs) | Updated frequently. |
